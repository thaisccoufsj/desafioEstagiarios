/*
	--- Versionamento ---
	08/03/2018 - Andrey - Data em pt_BR
	--- Fim Versionamento ---
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			...
			' title="Anterior' + /*prevText*/"" + '"><span class="ui-icon ui-icon-circle-triangle-' + ( isRTL ? 'e' : 'w') + '">' + prevText + '</span></a>' :
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			...
			' title="Pr�ximo'+ /*nextText*/"" + '"><span class="ui-icon ui-icon-circle-triangle-' + ( isRTL ? 'w' : 'e') + '">' + nextText + '</span></a>' :
